        ...
        <RoughNotationGroup>
          ...
          <div className="md:grid grid-rows-5 lg:grid-rows-6 grid-cols-5">
            ...
            <div
              ...
              ref={eduRef}
            >
              <p className="edu-bg my-4">Here is my Education & Professional Experience.</p>
...
const educationInfo = [
  {
    ...
    subTitle: "Arfa Kareem Software Technology Park | 2022 ~ 2024",
    list: [
      "Built and deployed full-stack applications using MongoDB, Express.js, React.js, and Node.js.",
      "Designed RESTful APIs, optimized database queries, and ensured scalability of applications.",
      "Worked on team-based projects simulating real-world software development environments.",
    ],
  },
  {
    id: 2,
title: "Assistant Software Engineer",
    subTitle: "Codebotx | 2024 - 2025",
    list: [
  "Assisted in developing and maintaining full-stack web applications.",
  "Worked with MERN stack technologies (MongoDB, Express.js, React.js, Node.js).",
    ],
  },
  {
    id: 3,
title: "Frontend & Shopify Developer",
subTitle: "Freelance / Projects | 2023 - 2025",
    list: [  "Designed and customized responsive storefronts using Shopify and Liquid templates.",
        "Integrated third-party apps and APIs to enhance e-commerce functionality.",
